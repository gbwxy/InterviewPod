...
export default function AudioRecorder({
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      {isRecording && (
        <div
          className="absolute rounded-full border border-zinc-400 dark:border-zinc-600/50 pointer-events-none transition-all duration-75"
          style={{
      ...
      <button
        ...
        className={`
          ...
          ${isRecording
            ? 'bg-zinc-200 dark:bg-zinc-800 hover:bg-zinc-200 dark:bg-zinc-800 '
            : 'bg-slate-700 hover:bg-zinc-200 dark:bg-zinc-800 shadow-slate-900/50'
          }
        `}
