  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={togglePlay}
          className="w-12 h-12 rounded-full bg-zinc-200 dark:bg-zinc-800 hover:bg-zinc-200 dark:bg-zinc-800
        ...
        <div className="flex items-center gap-2">
          <button onClick={toggleMute} className="text-zinc-500 hover:text-slate-600">
            {isMuted ? (
