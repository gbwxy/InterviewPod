...
export const InterviewEvent: React.FC<InterviewEventProps> = ({ event }) => {
  const statusConfig = {
    ...
    CANCELLED: {
      bg: 'bg-zinc-200 dark:bg-zinc-800/50',
      text: 'text-zinc-600 dark:text-zinc-400 dark:text-zinc-400',
      border: 'border-slate-300/60 border-zinc-200 dark:border-zinc-800/50',
      shadow: 'shadow-zinc-900/30 dark:shadow-zinc-900/30',
    },
    RESCHEDULED: {
