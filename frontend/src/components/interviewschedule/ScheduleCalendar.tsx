...
export const ScheduleCalendar: React.FC<ScheduleCalendarProps> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-zinc-100 dark:bg-zinc-900/50 backdrop-blur-xl rounded-2xl border border-zinc-200 dark:border-zinc-800/50 p-6 shadow-xl shadow-zinc-900/30 dark:shadow-zinc-900/30"
    >
      <DnDCalendar
          localizer={localizer}
          events={events}
