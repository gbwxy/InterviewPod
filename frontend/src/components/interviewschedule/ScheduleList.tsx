...
export const ScheduleList: React.FC<ScheduleListProps> = ({
  ...
  if (sortedInterviews.length === 0) {
    return (
      ...
      >
        <div className="bg-zinc-100 dark:bg-zinc-900/90 backdrop-blur-xl rounded-2xl border border-zinc-200 dark:border-zinc-800/50 p-12 shadow-xl">
          <p className="text-zinc-500 text-lg font-medium">暂无面试记录</p>
        </div>
      </motion.div>
    );
  }
  ...
  return (
    <div className="bg-zinc-100 dark:bg-zinc-900/90 backdrop-blur-xl rounded-2xl border border-zinc-200 dark:border-zinc-800/50 p-6 space-y-4">
