    ...
    >
      ...
      <div className="flex justify-between items-start mb-8 flex-wrap gap-6">
        <div>
          ...
          >
            <FileStack className="w-7 h-7 text-zinc-600 dark:text-zinc-400 dark:text-zinc-400" />
            简历库
          </motion.h1>
          <motion.p
        ...
        <motion.div
          className="flex items-center gap-3 bg-white border border-slate-200 rounded-xl px-4 py-2.5 min-w-[280px] focus-within:border-zinc-400 dark:border-zinc-600 focus-within:ring-2 focus-within:ring-zinc-500 transition-all"
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
        >
          ...
          <input
            ...
            className="flex-1 outline-none text-slate-700 placeholder:text-zinc-500"
          />
        </motion.div>
      </div>
              ...
              <AnimatePresence>
                {filteredResumes.map((resume, index) => (
                  <motion.tr
                    ...
                    className="border-b border-slate-50 hover:bg-zinc-200 dark:bg-zinc-800 cursor-pointer transition-colors group"
                  >
                    ...
                    <td className="px-6 py-4">
                      {resume.interviewCount > 0 ? (
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 text-emerald-600 rounded-full text-sm font-medium">
                          ...
                          <span
                              className="inline-flex px-3 py-1 bg-zinc-200 dark:bg-zinc-800 text-slate-500 dark:text-zinc-500 rounded-full text-sm">待面试</span>
                      )}
                    </td>
                      ...
                      <div className="flex items-center justify-end gap-1">
                        ...
                        {resume.storageUrl && (
                          <button
                            ...
                            className="p-2 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-400 dark:text-zinc-400 dark:text-zinc-400 hover:bg-zinc-200 dark:bg-zinc-800 rounded-lg transition-colors"
                            title="下载"
                          >
                        ...
                        {resume.analyzeStatus === 'FAILED' && (
                          <button
                            ...
                            className="p-2 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-400 dark:text-zinc-400 dark:text-zinc-400 hover:bg-zinc-200 dark:bg-zinc-800 rounded-lg transition-colors disabled:opacity-50"
                            title="重新分析"
                          >
                        ...
                        <button
                          ...
                          className="p-2 text-zinc-500 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors disabled:opacity-50"
                          title="删除"
                        >
                          <Trash2 className="w-4 h-4" />
                        </button>
                        <ChevronRight className="w-5 h-5 text-zinc-500 group-hover:text-zinc-600 dark:hover:text-zinc-400 dark:text-zinc-400 dark:text-zinc-400 group-hover:translate-x-1 transition-all" />
                      </div>
                    </td>
                  </motion.tr>
                ))}
