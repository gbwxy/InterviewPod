  ...
  return (
    <div className="relative group my-3">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-slate-700 rounded-t-xl border-b border-slate-600">
        ...
        <button
          onClick={handleCopy}
          className="flex items-center gap-1.5 px-2 py-1 text-xs text-zinc-500 hover:text-white hover:bg-zinc-200 dark:bg-zinc-800 rounded transition-colors"
          title="复制代码"
        >
          {copied ? (
            <>
      ...
      <div className="bg-[#282c34] rounded-b-xl text-sm leading-6">
        <Suspense fallback={
          <div className="p-4 text-zinc-500 font-mono text-xs">Loading code...</div>
        }>
          <SyntaxHighlighter
