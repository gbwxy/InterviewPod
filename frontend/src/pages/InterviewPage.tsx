    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center">
          ...
          <p className="text-zinc-500">正在生成面试题目...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center">
          ...
          <div className="flex gap-3 justify-center">
            ...
            <button
              onClick={onBack}
              className="px-5 py-2 bg-zinc-200 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 rounded-lg hover:bg-zinc-200 dark:bg-zinc-800"
            >
              返回
            </button>
          </div>
