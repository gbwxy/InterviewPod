...
const CARD_CLASS = `flex h-full min-h-[330px] flex-col rounded-xl border border-zinc-200 dark:border-zinc-800
  bg-zinc-100 dark:bg-zinc-900 p-5 transition-all hover:border-zinc-300 dark:border-zinc-700`;

const ICON_WRAP_CLASS = `flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg
  bg-zinc-200 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 dark:text-zinc-400`;

const DETAILS_CLASS = `mb-4 flex-1 space-y-1 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black/50
  p-3`;

const ACTION_BAR_CLASS = `mt-auto flex min-h-12 flex-wrap items-center gap-2 border-t
  border-zinc-200 dark:border-zinc-800 pt-3`;
...
function StatusBadge({ icon, children }: StatusBadgeProps) {
  return (
    <span className="inline-flex h-6 items-center gap-1.5 rounded-full bg-zinc-200 dark:bg-zinc-800 px-2.5 text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 border border-zinc-300 dark:border-zinc-700">
      {icon}
      {children}
    </span>
  );
  ...
  return (
    <div
      className={`grid grid-cols-[108px_minmax(0,1fr)] items-start gap-3 rounded-md px-2 py-2 text-xs ${
        emphasis ? 'bg-zinc-100 dark:bg-zinc-900/80 ring-1 ring-zinc-800' : ''
      }`}
    >
      <dt className="whitespace-nowrap text-zinc-500">{label}</dt>
      <dd
        className={`min-w-0 truncate text-right font-medium text-zinc-500 dark:text-zinc-300 dark:text-zinc-300 ${
          monospace ? 'font-mono' : ''
        }`}
        title={title}
      >
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-black dark:text-white flex items-center gap-2.5">
          <Settings className="w-5 h-5 text-zinc-600 dark:text-zinc-400 dark:text-zinc-400" />
          系统设置
        </h1>
        <p className="text-zinc-500 text-sm mt-1">管理聊天模型、向量模型和模块配置</p>
      </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
              ...
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-sm font-semibold text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 uppercase tracking-wider">
                  模型服务
                </h2>
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-2 px-3.5 py-2 rounded-lg font-medium text-sm
                    bg-black text-white hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-100 transition-all"
                >
              ...
              {providers.length === 0 ? (
                <div className="text-center py-16 bg-zinc-100 dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800">
                  <Server className="w-10 h-10 text-zinc-500 dark:text-zinc-300 mx-auto mb-3" />
                  <p className="text-zinc-600 dark:text-zinc-400 text-sm">暂无 Provider，点击上方按钮新增</p>
                </div>
              ) : (
                    ...
                    >
                      ...
                      <div className="mb-4 flex items-start justify-between gap-3">
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <h3 className="truncate text-sm font-semibold text-zinc-900 dark:text-zinc-200">
                              {provider.id}
                            </h3>
                            <p className="mt-1 text-xs text-zinc-600 dark:text-zinc-400">聊天/向量 Provider</p>
                          </div>
                        </div>
                        ...
                        <motion.div
                          ...
                          className={`mb-3 px-3 py-2 rounded-lg text-xs font-medium ${
                            testResults[provider.id].success
                              ? 'bg-zinc-200 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-300 dark:text-zinc-300 border border-zinc-300 dark:border-zinc-700'
                      ...
                      <div className={ACTION_BAR_CLASS}>
                        <button
                          ...
                          className={`${ACTION_BUTTON_CLASS} text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 hover:bg-zinc-200 dark:bg-zinc-800 hover:text-zinc-900 dark:text-zinc-200`}
                          title="编辑"
                        >
                        ...
                        <button
                          ...
                          className={`${ACTION_BUTTON_CLASS} text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 hover:bg-zinc-200 dark:bg-zinc-800 hover:text-zinc-900 dark:text-zinc-200 disabled:hover:bg-transparent`}
                          title="设为默认文字服务"
                        >
                        ...
                        <button
                          ...
                          className={`${ACTION_BUTTON_CLASS} ml-auto text-zinc-600 dark:text-zinc-400 hover:bg-red-500/10 hover:text-red-400`}
                          title="删除"
                        >
              ...
              {/* Voice service cards */}
              <div className="mt-6">
                <h2 className="text-sm font-semibold text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 uppercase tracking-wider mb-4">
                  语音服务
                </h2>
                <div className="grid grid-cols-1 items-stretch gap-4 md:grid-cols-2">
                  {/* ASR Card */}
                      ...
                      <div className="mb-4 flex items-start justify-between gap-3">
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="mt-1 text-xs text-zinc-600 dark:text-zinc-400">实时语音转写配置</p>
                          </div>
                        </div>
                      ...
                      <div className="mb-4 flex items-start justify-between gap-3">
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="mt-1 text-xs text-zinc-600 dark:text-zinc-400">文本转语音输出配置</p>
                          </div>
                        </div>
          ...
          <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              <motion.div
                ...
                className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-2xl max-w-lg w-full p-6"
              >
                ...
                <div className="space-y-4">
                  {/* Provider ID */}
                  <div>
                    <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2.5 rounded-lg border border-zinc-300 dark:border-zinc-700
                        ...
                        placeholder:text-zinc-600 dark:text-zinc-400 focus:outline-none focus:ring-1
                  ...
                  <div>
                    <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">
                      API Key{' '}
                      {editingProvider && (
                        <span className="text-zinc-600 dark:text-zinc-400 font-normal">(留空则不修改)</span>
                      )}
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-2.5 pr-10 rounded-lg border border-zinc-300 dark:border-zinc-700
                          bg-zinc-200 dark:bg-zinc-800 text-sm text-zinc-900 dark:text-zinc-200
                          placeholder:text-zinc-600 dark:text-zinc-400 focus:outline-none focus:ring-1
                          focus:ring-zinc-500 focus:border-zinc-500 transition-shadow"
                      />
                      <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-500
                          hover:text-zinc-500 dark:hover:text-zinc-500 dark:text-zinc-300 dark:text-zinc-300 transition-colors"
                      >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      {showModelDropdown && currentPreset && (
                        <div className="absolute z-10 mt-1 w-full bg-zinc-200 dark:bg-zinc-800
                          border border-zinc-300 dark:border-zinc-700 rounded-xl shadow-lg
                          ...
                          {currentPreset.models.map((m) => (
                            <button
                              ...
                              className={`w-full px-4 py-2.5 text-left text-sm hover:bg-zinc-300 dark:bg-zinc-700
                                transition-colors flex justify-between items-center
                                ${formModel === m.value
                                  ? 'text-black dark:text-white font-medium bg-zinc-300 dark:bg-zinc-700'
                                  : 'text-zinc-500 dark:text-zinc-300 dark:text-zinc-300'}`}
                            >
                              <span className="font-mono">{m.value}</span>
                              <span className="text-xs text-zinc-600 dark:text-zinc-400 ml-2 whitespace-nowrap">{m.label}</span>
                            </button>
                          ))}
                        </div>
                      )}
                  ...
                  <div>
                    <div className="mb-1.5 flex items-center justify-between gap-3">
                      <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400">
                        向量模型 <span className="text-zinc-600 dark:text-zinc-400 font-normal">(知识库向量化，例如 GLM 填 embedding-3)</span>
                      </label>
                      <label className="inline-flex items-center gap-2 text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400">
                        <input
                          type="checkbox"
                          ...
                          className="h-4 w-4 rounded border-zinc-400 dark:border-zinc-600 text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 focus:ring-zinc-500 bg-zinc-200 dark:bg-zinc-800"
                        />
                        支持 Embedding
                      </label>
                    </div>
                  ...
                  {formSupportsEmbedding && (
                    <div>
                      <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">
                        向量维度 <span className="text-zinc-600 dark:text-zinc-400 font-normal">(必须与 pgvector 表一致，当前为 1024)</span>
                      </label>
                      <input
                        type="number"
                        min={1}
                  ...
                  <div>
                    <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">
                      Temperature <span className="text-zinc-600 dark:text-zinc-400 font-normal">(可选, 默认 0.2)</span>
                    </label>
                    <input
                      type="text"
                ...
                <div className="flex gap-3 justify-end mt-6">
                  ...
                  <motion.button
                    ...
                    disabled={saving}
                    className="px-4 py-2 text-zinc-900 rounded-lg font-medium text-sm
          ...
          <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              <motion.div
                ...
                exit={{ opacity: 0, scale: 0.95, y: 20 }}
                onClick={(e) => e.stopPropagation()}
                className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-2xl max-w-lg w-full p-6 max-h-[85vh] overflow-y-auto"
              >
                <h3 className="text-base font-semibold text-black dark:text-white mb-5">
                ...
                {showVoiceModal === 'asr' ? (
                  <div className="space-y-4">
                    <p className="text-xs font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider">连接配置</p>
                    <div>
                      <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">WebSocket URL</label>
                      <input type="text" value={asrForm.url || ''} onChange={(e) => setAsrForm(f => ({ ...f, url: e.target.value }))}
                        className="w-full px-3 py-2.5 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-zinc-200 dark:bg-zinc-800 text-sm text-zinc-900 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-500 focus:border-zinc-500 transition-shadow" />
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Model</label>
                        <input type="text" value={asrForm.model || ''} onChange={(e) => setAsrForm(f => ({ ...f, model: e.target.value }))}
                          className="w-full px-3 py-2.5 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-zinc-200 dark:bg-zinc-800 text-sm text-zinc-900 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-500 focus:border-zinc-500 transition-shadow" />
                      </div>
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">API Key <span className="text-zinc-600 dark:text-zinc-400 font-normal">(留空不改)</span></label>
                    ...
                    <div>
                      <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Language</label>
                      <input type="text" value={asrForm.language || ''} onChange={(e) => setAsrForm(f => ({ ...f, language: e.target.value }))}
                        className="w-full px-3 py-2.5 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-zinc-200 dark:bg-zinc-800 text-sm text-zinc-900 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-500 focus:border-zinc-500 transition-shadow" />
                    </div>

                    <p className="text-xs font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider pt-2">音频参数</p>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Format</label>
                        <input type="text" value={asrForm.format || ''} onChange={(e) => setAsrForm(f => ({ ...f, format: e.target.value }))}
                          className="w-full px-3 py-2.5 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-zinc-200 dark:bg-zinc-800 text-sm text-zinc-900 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-500 focus:border-zinc-500 transition-shadow" />
                      </div>
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Sample Rate</label>
                        <input type="number" value={asrForm.sampleRate || 0} onChange={(e) => setAsrForm(f => ({ ...f, sampleRate: Number(e.target.value) }))}
                          className="w-full px-3 py-2.5 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-zinc-200 dark:bg-zinc-800 text-sm text-zinc-900 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-500 focus:border-zinc-500 transition-shadow" />
                      </div>
                    </div>

                    <p className="text-xs font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider pt-2">VAD 参数</p>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Turn Detection</label>
                      ...
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Detection Type</label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Threshold</label>
                      ...
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Silence Duration (ms)</label>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-xs font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider pt-2">语音参数</p>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Voice</label>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Mode</label>
                    ...
                    <p className="text-xs font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider pt-2">输出控制</p>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Speech Rate</label>
                        <input type="number" step="0.1" value={ttsForm.speechRate || 0} onChange={(e) => setTtsForm(f => ({ ...f, speechRate: Number(e.target.value) }))}
                          className="w-full px-3 py-2.5 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-zinc-200 dark:bg-zinc-800 text-sm text-zinc-900 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-500 focus:border-zinc-500 transition-shadow" />
                      </div>
                      <div>
                        <label className="block text-xs font-medium text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 mb-1.5">Volume</label>
                ...
                <div className="flex gap-3 justify-end mt-6">
                  <motion.button
                    ...
                    className="px-4 py-2 border border-zinc-300 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 rounded-lg font-medium text-sm hover:bg-zinc-200 dark:bg-zinc-800 hover:text-zinc-900 dark:text-zinc-200 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    取消
                  ...
                  <motion.button
                    ...
                    disabled={voiceSaving}
                    className="px-4 py-2 text-zinc-900 rounded-lg font-medium text-sm bg-white hover:bg-zinc-100 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    {voiceSaving ? (
          ...
          <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              >
                ...
                <p className="text-zinc-600 dark:text-zinc-400 dark:text-zinc-400 text-sm mb-6">
        ...
        {toast && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 50, x: '-50%' }}
                  className={`fixed bottom-6 left-1/2 px-4 py-2.5 rounded-lg shadow-lg text-sm font-medium
              flex items-center gap-2 z-[60] border ${
                toast.type === 'success'
                  ? 'bg-zinc-200 dark:bg-zinc-800 border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-zinc-200'
